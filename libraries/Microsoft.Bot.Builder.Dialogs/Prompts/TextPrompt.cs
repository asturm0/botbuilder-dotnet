...
namespace Microsoft.Bot.Builder.Dialogs
{
    ...
    public class TextPrompt : Prompt<string>
    {
        ...
        /// </summary>
        /// <param name="dialogId">The ID to assign to this prompt.</param>
        /// <param name="validator">A <see cref="PromptValidator{string}"/> that contains additional,
        /// custom validation for this prompt.</param>
        ...
        public TextPrompt(string dialogId, PromptValidator<string> validator, int attempts, ValidationFailed validationFailed)
